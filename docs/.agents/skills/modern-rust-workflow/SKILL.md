...
* **Trunk-Based Development:** Push directly to `main` (or short-lived feature branches that merge quickly). Avoid long-running divergence. Hide unfinished features behind feature flags (`#[cfg(feature = "unstable")]`).
