...
- OG / Twitter カード画像
- GitHub Release ページ（本文の「添付ファイルの説明」と添付の `RELEASE-README.md`。テンプレは `.github/release-readme.md` / `.github/release-notes-assets.md` で、`release.yml` の sbom ジョブが毎リリース自動生成する）
