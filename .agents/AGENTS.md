...
3. **Record Mistakes into Memory**: If a failure occurs due to a lack of knowledge or a flawed assumption, you must immediately document the correct process in this `AGENTS.md` file so that it is never repeated.
