...
- **Anti-Slop UI (No Emojis)**: NEVER use standard OS emojis (🍎, 💼, 🏠, etc.) as icons in UI mockups or structural design elements. This is a severe AI anti-pattern. Use abstract CSS, SVGs, or professional iconography (like Phosphor/Lucide) if icons are required, or rely purely on high-end typography.
